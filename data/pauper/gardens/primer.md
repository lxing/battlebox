Gardens is a BGr grindy midrange-control deck that wins by trading resources and generating steady value. The shell uses small artifacts and tokens as fuel for [[Deadly Dispute]] and [[Fanatical Offering]], while a dense removal suite like [[Defile]], [[Cast Down]], [[Snuff Out]], and [[Spinning Darkness]] trades down opposing threats. The deck pivots from stabilization to pressure using Monarch and Initiative.
