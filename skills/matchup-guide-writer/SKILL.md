...
2. **Use existing primers**: Read `data/<battlebox>/<deck>/primer.md` and the opponent’s `data/<battlebox>/<opponent>/primer.md` if present. Use those as the primary strategy source.
